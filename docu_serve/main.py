...
# app/main.py import sqlite3from fastapi import FastAPI, HTTPException, Depends, statusfrom passlib.context import CryptContextfrom jose import jwtfrom datetime import datetime, timedeltafrom fastapi.security import OAuth2PasswordRequestForm
import sqlite3
...
def register_user(name: str, email: str, age: int, password: str, role: str = "user"):
    conn = get_db()
    cursor = conn.cursor()
